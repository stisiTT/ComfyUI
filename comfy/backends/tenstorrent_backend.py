...
class TenstorrentBackend:
    ...
    def _send_receive(self, operation: str, data: Dict[str, Any], request_id: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def full_denoise(self, model_id: str, **params) -> Dict[str, Any]:
        ...
        result = self._send_receive(operation="full_denoise", data=data)
